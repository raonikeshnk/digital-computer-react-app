// Make sure AOS is initialized after the document is fully loaded
document.addEventListener('DOMContentLoaded', function () {
    ...
    //Dynamic text on main 
    function changeDynamicText() {
        const dynamicText = document.getElementById("dynamic-text");
        const texts = ["Website", "App", "Game"]; // Array of text options
        let currentTextIndex = 0;

        setInterval(function () {
            dynamicText.innerHTML = `Best Place To Learn <br><b><em>${texts[currentTextIndex]} Development</em></b>`;
            currentTextIndex = (currentTextIndex + 1) % texts.length;
        }, 2000); // Change text every 2 seconds (you can adjust this interval)
    }

    // Call the function to start the text change
    changeDynamicText();
